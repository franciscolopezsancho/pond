...
/**
  * This provides an event sourced behavior. It has a state, [[PondState]], which
...
/**
  ...
  */
case class PondState(message: String, timestamp: String) {
...
object PondState {
  ...
  /**
    ...
    */
  def initial: PondState = PondState("Hello", LocalDateTime.now.toString)
...
/**
  ...
  */
case class GreetingMessageChanged(message: String) extends PondEvent
